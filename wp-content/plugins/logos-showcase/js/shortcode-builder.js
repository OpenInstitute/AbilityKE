function lshowcaseshortcodegenerate() {
	...
	shortcode_string = "[show-logos orderby='"+order+"' category='"+category+"' activeurl='"+url+"' style='"+style+"' interface='"+layout+"' tooltip='"+tooltip+"' description='"+description+"' limit='"+limit+"' filter='"+filter+"' "+carousel + img_code + class_code + tag_code + "]";

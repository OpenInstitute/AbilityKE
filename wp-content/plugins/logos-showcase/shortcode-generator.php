...
function lshowcase_run_preview()
{
  ...
  $ids = '';
	...
	$html = build_lshowcase($orderby, $category, $tag, $activeurl, $style, $interface, $tooltip, $description, $limit, $slidersettings, $img, $ids, $filter, $class);
	echo $html;
...
<div id="ls_filter_option">
   ...
   <label for="filter">Show <?php echo $catlabel; ?> Filter Menu:</label>

...
function polo_custom_styles() {
	...
	if ( isset( $st_head_height ) && ! empty( $st_head_height ) ) {
		...
		$custom_css .= '#page-title{';
		$custom_css .= 'padding-bottom:' . intval( $st_head_height / 2 - 25 ) . 'px !important;';
		if (strpos('transparent',$classic_header_style)){
			$custom_css .= 'padding-top:' . intval( $st_head_height / 2 + 90 ) . 'px !important;}';
		} else {
			$custom_css .= 'padding-top:' . intval( $st_head_height / 2- 25 ) . 'px !important;}';
		}

<form class="rwdform" method="POST" enctype="multipart/form-data" name="questionnaire" id="outdoorForm" action="action.php">
    ...
    <div class="form-group">
        <label class="col-md-4" for="building_type">Street Name</label>
        <div class="col-md-8">
            <input type="text" name="department_faculty" id="department_faculty" required class="form-control" placeholder="Street name (e.g. Haile Gebre Silase St, Addis)"> 
        </div> 
    </div>

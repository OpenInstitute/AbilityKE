<form class="rwdform" method="POST" enctype="multipart/form-data" name="outdoor_questionnaire" id="indoorFormPublic" action="action.php">
    <input type="hidden" name="form" value="indoor">
    
    <div class="form-group buildingsXX">
        <div class="input-group-prepend">
            <label class="input-group-text col-md-4" for="entity_code"> Add Entity </label>
        </div>
        <div class="col-md-8">
        <input type="text" name="entity_code" id="entity_code" value="" placeholder="Add a new place" class="form-control">
        </div>
    </div>
...
<div class="form-group">
<label class="col-md-4" for="Posted_By">User IP Address</label>
<div class="col-md-8">
<input type="text" name="IP_Addr" id="IP_Addr" size="255" maxlength="255" readonly value="" class="form-control">
</div> 
</div>

<div class="form-group">
<label class="col-md-4" for="Posted_By">User Device User Agent </label>
<div class="col-md-8">
<input type="text" name="userAgent" id="userAgent" size="255" maxlength="255" readonly value="" class="form-control">
</div> 
</div>

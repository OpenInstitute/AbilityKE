<form class="rwdform" method="POST" enctype="multipart/form-data" name="questionnaire" id="indoorForm" action="action.php">
    ...
    <div class="form-group buildingsXX">
        <div class="input-group-prepend">
            <label class="input-group-text col-md-4" for="entity_code"> Add Indoor Entry Manually </label>
        </div>
        <div class="col-md-8">
        <input type="text" name="entity_code" id="entity_code" value="" placeholder="Manually add a building (e.g Capital Hotel and Spa )" class="form-control">
        </div>
    </div>
...
<div class="col-md-8 row">
    <div class="col-md-4"> Name: </div> <div class="col-md-8"> <input type="text" name="Posted_By" id="Posted_By" size="255" maxlength="255"  value="" class="form-control"></div> <br/>
    <div class="col-md-12">&nbsp;</div>
    <div class="col-md-4"> Email <i>(Optional)</i>: </div> <div class="col-md-8">  <input type="email" name="Posted_By_Email" id="Posted_By_Email" size="255" maxlength="255"  value="" class="form-control"></div>
    <div class="col-md-12"><em>Your email is strictly confidential, we will not share your email with third party services or spam you with unsolicited emails. </em></div>

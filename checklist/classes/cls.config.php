...
define('RDR_REF_PATH', $this_page);

$domain_conf['live'] = array();

/*define('DOMAIN_DEVHUB', 	   "http://".$domain_url."/devhub/" );	*/
define('DOMAIN_DEVHUB', 	   "http://devolutionhub.or.ke/" );	
...
define('UPL_USERPICS', 		   SITE_PATH ."images/userpics/"); 
define('DISP_USERPICS', 		  SITE_DOMAIN_LIVE ."images/userpics/");
